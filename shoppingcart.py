...
product_ids = [] # temporary list of valid ids for testing purposes

while True:
    product_id = input("Please input a valid product identifer:")
    if product_id == "DONE":
...
print("-------------------------------")
print("BEST GROCERY STORE EVER")
print("-------------------------------")
print("Web: www.bestgrocery.com")
print("Phone: 555-5555")
